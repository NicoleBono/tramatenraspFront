...
$form = array(
	...
	'fields' => array(
		...
		'custom_U2650' => array(
			'order' => 4,
			'type' => 'checkbox',
			'label' => 'Aceita assinar nossa neswletter',
			'required' => true,
			'errors' => array(
				'required' => 'O campo \"Aceita assinar nossa neswletter\" é obrigatório.'
			)
		),
		'custom_U2725' => array(
			'order' => 5,
			...
			'required' => true,
			'errors' => array(
				'required' => 'O campo \"Receber notificações de eventos\" é obrigatório.'
			)
		)
	)
);
